        ...
        <main class="column main-content">
            ...
            <div class="columns">
                <div class="column is-3">
                    <label for="" class="label is-small">Periode</label>
                ...
                <div class="column is-2">
                    <div style="height: 18px; margin-bottom: 0.5rem;"></div>
                        <input type="submit" class="button is-small is-link sbm-btn" value="Filter">
                    </div>
            </div>
            <div class="columns">
                    ...
                    <table class="table is-bordered is-narrow is-fullwidth">
                        <thead>
                            <tr class="is-selected">
                                <th style="text-align: center; font-size: 12px;">Tanggal</th>
                                ...
                                <th style="text-align: center; font-size: 12px;">Sifat</th>
                                <th></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td style="text-align: center; font-size: 12px;">1/1/2018</td>
                                <td style="text-align: center; font-size: 12px;"></td>
                                <td style="text-align: center; font-size: 12px;">-- Semua --</td>
                                <td style="text-align: center; font-size: 12px;">-- Semua --</td>
                                <td style="text-align: center; font-size: 12px;">Lebak Bulus</td>
                                <td style="text-align: center; font-size: 12px;">Biasa</td>
                                <td style="text-align: center; font-size: 12px;"><a href="">Delete</a></td>
                            </tr>
                            <tr>
                                <td style="text-align: center; font-size: 12px;">1/2/2018</td>
                                <td style="text-align: center; font-size: 12px;"></td>
                                <td style="text-align: center; font-size: 12px;">-- Semua --</td>
                                <td style="text-align: center; font-size: 12px;">-- Semua --</td>
                                <td style="text-align: center; font-size: 12px;">Lebak Bulus</td>
