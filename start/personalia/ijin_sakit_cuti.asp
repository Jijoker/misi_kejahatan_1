      ...
      <aside class="menu column hero aside-menu-fixed">
        ...
        <main class="column main-content">
            ...
            <div class="field column">
                <h4 class="title is-4">
                    Ijin / Sakit / Cuti / Tugas / Liburan Pegawai
                </h4>
            </div>
            ...
            <div class="columns columns-section">
                ...
                <div class="column is-2">
                    ...
                    <input type="submit" class="button is-small is-link sbm-btn" value="Filter Data Pegawai">
                </div>
            </div>
            <div class="columns">
                <div class="column is-4">
                    <article class="message is-warning">
                        ...
                        <div class="message-body">
                            Data bulan lalu tidak bisa dimodifikasi kecuali Level 5.
                        </div>
                    </article>
                </div>
            </div>
            <div class="content-section">
                <label for="" class="label title-label">Department: IT</label>
                <div class="columns">
                    <div class="column is-3">
                        <label for="" class="label is-small">Nama Pegawai</label>
                        <div class="select is-small dropdown-list">
                            <select name="" id="">
                                <option value="">Lorem, ipsum.</option>
                                <option value="">Lorem, ipsum.</option>
                    ...
                    <div class="column is-3">
                        <label for="" class="label is-small">Periode Data</label>
                    ...
                    <div class="column is-2">
                        <div style="height: 18px; margin-bottom: 0.5rem;"></div>
                        <input type="submit" class="button is-small is-link sbm-btn" value="Display Data">
                    </div>
                </div>
            </div>
            <div class="columns">
                <div class="column is-7">
                    <label class="label is-small" style="display: inline; text-transform: uppercase;">Fuad Ristiyanto</label>
                    ...
                    <table class="table is-bordered is-narrow is-fullwidth">
                        <thead>
                            <tr class="is-selected">
                                ...
                                <th style="text-align: center; font-size: 12px;">Tanggal (mm/dd/yyyy)</th>
                                <th style="text-align: center; font-size: 12px;">Jenis Ijin</th>
                                <th style="text-align: center; font-size: 12px;">Alasan/Penjelasan</th>
                                <th></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td style="text-align: center; font-size: 12px;">16979</td>
                                <td style="text-align: center; font-size: 12px;">12/12/2017 - 12/15/2017</td>
                                <td style="text-align: center; font-size: 12px;">Cuti</td>
