        ...
        <main class="column main-content">
            ...
            <div class="columns columns-section">
                ...
                <div class="column is-2">
                    ...
                    <input type="submit" class="button is-small is-link sbm-btn" value="Filter Daftar Pegawai">
                </div>
            </div>
            <div class="columns">
            ...
            <div class="columns">
                <div class="column is-7">
                    <a href="" class="button is-small is-warning" style="font-size: 0.6rem; float: right;">
                        <i class="fa fa-floppy-o" aria-hidden="true" style="margin-right: 6px;"></i>
                        Save Worksheet Data
                    </a>
                    <table class="table is-bordered is-narrow is-fullwidth">
                        <thead>
                            <tr class="is-selected">
                                ...
                                <th style="text-align: center; font-size: 12px;">Status Hari</th>
                                <th style="text-align: center; font-size: 12px;">Status Kerja</th>
                                <th></th>
                            </tr>
                        </thead>
                    </table>
