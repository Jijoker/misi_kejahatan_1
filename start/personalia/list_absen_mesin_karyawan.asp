        ...
        <main class="column main-content">
            ...
            <div class="content-section">
                ...
                <div class="columns">
                    ...
                    <div class="column is-2">
                        <div style="height: 18px; margin-bottom: 0.5rem;"></div>
                        <input type="submit" class="button is-small is-link sbm-btn" value="Display Data Absen">
                    </div>
                </div>
            </div>
            <div class="columns">
                    ...
                    <table class="table is-bordered is-narrow is-fullwidth">
                        <thead>
                            <tr class="is-selected">
                                ...
                                <th style="text-align: center; font-size: 12px;">Alias</th>
                                ...
                                <th style="text-align: center; font-size: 12px;">Jam Clock-In/Out</th>
                            </tr>
                        </thead>
                    </table>
                </div>
